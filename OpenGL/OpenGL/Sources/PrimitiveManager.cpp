...
unsigned int PrimitiveManager::cubeVAO = 0;
unsigned int PrimitiveManager::cubeVBO = 0;
unsigned int PrimitiveManager::quadVAO = 0;
...
void PrimitiveManager::DrawQuad(Shader & shader, Camera & camera, glm::vec3 position, glm::vec3 rotation, glm::vec3 scale, Texture * diffuse, Texture * specular)
{
	const Settings* settings = GlobalInstance::GetInstance()->GetSettings();
...
void PrimitiveManager::SetupCube()
{
...
void PrimitiveManager::SetupQuad()
{
	if (quadVAO == 0)
	{
		// positions
...
void PrimitiveManager::SetupSkybox()
{
	if (skyboxVAO == 0)
	{
